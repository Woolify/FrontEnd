...
class VendorRegisteration extends ConsumerStatefulWidget {
  const VendorRegisteration({super.key});
  @override
  ConsumerState<VendorRegisteration> createState() {
    return _VendroRegisteration();
  }
}

class _VendroRegisteration extends ConsumerState<VendorRegisteration> {
