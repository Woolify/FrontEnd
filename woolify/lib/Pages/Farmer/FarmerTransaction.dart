...
class farmerTransaction extends ConsumerStatefulWidget {
  farmerTransaction({super.key});
...
class _farmerTransactionState extends ConsumerState<farmerTransaction> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(FarmerAuctionListProvider.notifier).getData();
    });
    super.initState();
  }
  ...
  Widget build(context) {
    data = ref.watch(FarmerAuctionListProvider);

    return Scaffold(
      appBar: AppBar(
        title: const Text("Open Acution"),
        centerTitle: true,
      ),
      body: data == null
          ? Center(
